    ...
    <>
      ...
      <nav className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex justify-between items-center z-50">
        ...
        <ul className="hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white shadow-sm bg-opacity-50">
          ...
          <li>
            <a className="font-Ovo" href="#servives">
              Servives
            </a>
          </li>
          <li>
        ...
        <ul
          ...
          top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transiton duration-500"
        >
          ...
          <li>
            <a className="font-Ovo" onClick={closeMenu} href="#servives">
              Servives
            </a>
          </li>
          <li>
